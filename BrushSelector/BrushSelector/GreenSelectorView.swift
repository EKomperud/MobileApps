//
//  GreenSelectorView.swift
//  BrushSelector
//
//  Created by u0844210 on 2/5/17.
//  Copyright © 2017 cs4530. All rights reserved.
//

import UIKit

protocol GreenSelectorDelegate: class {
    func greenSelector(redSelector: GreenSelectorView, rotatedToAngle angle: Float)
}

class GreenSelectorView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        // Add gradient
        let colors = [CGColor(colorSpace: CGColorSpaceCreateDeviceRGB(), components: [0.0,0.0,0.0]), UIColor.green.cgColor]
