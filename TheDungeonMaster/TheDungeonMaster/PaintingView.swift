...
class PaintingView: UIView {
    ...
    // Current stroke
    var stroke = Stroke(W: 1.0, C: UIColor.black.cgColor, Join: CGLineJoin.round, Cap: CGLineCap.round)
    ...
    override func draw(_ rect: CGRect) {
        ...
        if _tempX == 0 {
            ...
            if painting.strokes.isEmpty {
                context.setFillColor(cyan: 0.0, magenta: 0.0, yellow: 0.0, black: 0.0, alpha: 1.0)
    ...
    func Clear() {
        painting.strokes.removeAll()
        self.stroke = Stroke(W: 1.0, C: UIColor.black.cgColor, Join: CGLineJoin.round, Cap: CGLineCap.round)
